...
export function DesignBar() {
  ...
  const {
    ...
    useShallow((s) => ({
      ...
      setShowEaseNotches: s.setShowEaseNotches,
      ...
      setShowMirrorCenterLine: s.setShowMirrorCenterLine,
  ...
  const sections: DisplaySection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Entspannung', checked: showEaseNotches, toggle: setShowEaseNotches },
        ...
        { label: 'Mittellinie (Spiegel)', checked: showMirrorCenterLine, toggle: setShowMirrorCenterLine },
