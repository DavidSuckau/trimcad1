...
export const HELP_ENTRIES: HelpEntry[] = [
  ...
  },
  {
    ...
    description:
      'Aus dem Laufrichtungs-Menü (Leertaste am Fadenlauf): erzeugt ein abhängiges Kaschierungsteil neben dem Mutterteil. Die Schnittkontur erhält an scharfen Ecken Chamfers maximal bis zum Naht-Eckpunkt; die Nahtlinie bleibt eckig. Die Kaschierung wird nur von der Mutter synchronisiert – Kontur, Kerben und Internals sind dort nicht manuell editierbar (Position/Drehung schon). Aus einer Kaschierung kann keine weitere erzeugt werden; Löschen der Mutter entfernt auch die Kaschierung.',
