...
export const HELP_ENTRIES: HelpEntry[] = [
  ...
  },
  {
    ...
    description:
      'Laufrichtungspfeil anfahren und Leertaste: Menü zum Spiegeln, Löschen, Kopieren, Kaschierung erzeugen, Spiegelkopie erzeugen und Teil-Eigenschaften. „Kaschierung erzeugen“ legt ein abhängiges Tochterteil leicht versetzt unter der Mutter an (1 cm rechts/oben, damit es hervorschaut; gefüllte Schraffur, Außenecken in der Nahtzugabe angephast); „Spiegelkopie erzeugen“ legt eine geflippte abhängige Kopie an. Kontur/Notches folgen der Mutter, Position bleibt lokal. Material wird beim Anlegen übernommen, ist am Tochterteil aber separat änderbar. Nur im Layout-Modus (Kontur bearbeiten aus): Teil ausgewählt, am Schaft ziehen zum parallelen Verschieben; an Anfang oder Ende (Punkte) ziehen, um die Linie länger/kürzer zu machen und die Richtung anzupassen. Loslassen mit Linienmitte nahe einer Schnittkontur-Kante: parallel zur Kante ausrichten und auf die Kante legen. Umschalt beim Loslassen: kein Snappen. Im Kontur-Bearbeitungsmodus ist die Laufrichtung nicht verschiebbar.',
  ...
  },
  {
    ...
    description:
      'Aus dem Laufrichtungs-Menü (Leertaste am Fadenlauf): erzeugt ein abhängiges Kaschierungsteil leicht versetzt unter dem Mutterteil (1 cm rechts und 1 cm nach oben, damit es hervorschaut). Die Schnittkontur erhält an scharfen Ecken Chamfers maximal bis zum Naht-Eckpunkt; die Nahtlinie bleibt eckig. Die Kaschierung wird nur von der Mutter synchronisiert – Kontur, Kerben und Internals sind dort nicht manuell editierbar (Position/Drehung und Laufrichtung schon; Laufrichtung im Layout-Modus verschieben). Material wird beim Anlegen von der Mutter übernommen, kann am Kaschierungsteil aber separat geändert werden. Hat die Mutter bereits Spiegelkopien, erhalten diese automatisch ebenfalls eine Kaschierung. Aus einer Kaschierung kann keine weitere abhängige Kopie erzeugt werden; Löschen der Mutter entfernt auch die Kaschierung.',
  ...
  },
  {
    ...
    name: 'Schrumpfen (%)',
    description:
      'Genau ein Teil auswählen. Unter Bearbeiten → Schrumpfen (%): aktuelle Größe = 100 %. Eingabe z. B. 2 vergrößert um 2 %, −2 verkleinert um 2 %. Skalierung um den Drehpunkt; Kontur, Kerben, Internals und Bohrungen mit. Abhängige Kaschierung/Spiegelkopie: nur an der Mutter.',
    access: 'Teil auswählen → Menü Bearbeiten → Schrumpfen (%)',
  },
  {
    category: 'Werkzeuge',
    name: '90° drehen',
  ...
  },
  {
    ...
    name: 'Drehgriff',
    description:
      'Drehpunkt und Drehgriff am ausgewählten Teil ein- oder ausblenden. Drehen per Alt+D (Drehmodus) und Tastenkürzel bleiben möglich.',
    access: 'Unten → Anzeige → Drehgriff',
    shortcut: undefined,
  },
  {
    category: 'Ansicht',
